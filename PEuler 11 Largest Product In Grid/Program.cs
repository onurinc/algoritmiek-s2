...
namespace PEuler_11_Largest_Product_In_Grid
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int endproduct = 0;
            int[,] grid = new int[sizeX, sizeY] { { 08, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 08 },
            ...
            for (int i = 0; i < sizeX - 3; i++)
                for (int j = 0; j < sizeY - 3; j++)
                {
                    int product = grid[j, i] * grid[j + 1, i + 1] * grid[j + 2, i + 2] * grid[j + 3, i + 3];
